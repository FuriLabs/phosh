...
/* The glass colour the shell's CSS arrives at, computed here in numbers so
 * the text colour can be reasoned about. Mirrors the mix() chain generated
 * for @phosh_glass_bg_color. */
static void
